  ...
  public: {
    Tables: {
      absen_locations: {
        ...
        Relationships: [
          {
            foreignKeyName: "absen_locations_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
      ...
      absen_schedules: {
        ...
        Relationships: [
          {
            foreignKeyName: "absen_schedules_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "absen_schedules_member_id_fkey1"
            columns: ["member_id"]
            isOneToOne: false
      ...
      group_members: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "group_members_member_id_fkey1"
            columns: ["member_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
